...
export default function FillingGlobe({
  className = undefined,
  ...props
}: Readonly<GlobeProps & { className?: string }>) {
  // This component is a wrapper around react-globe.gl that fills the entire element and resizes with the element

  // viewport width and height
  const [globeViewElement, setGlobeViewElement] =
  ...
  return (
    <div ref={handleGlobeViewRef} className={className}>
      <Globe height={globeHeight} width={globeWidth} {...props} />
    </div>
  );
}
