...
export default function MapView({ className = undefined, point1, point2, triangulatedPoint }: Readonly<{ className?: string, point1: GPSPointData | null, point2: GPSPointData | null, triangulatedPoint: GPSPointData | null }>) {
      ...
      >
        ...
        >
          <Popup>
            ...
            {point1.hasOwnProperty("imageBase64") && <img src={point1.imageBase64} className={"w-36"} alt={"Point 1"}/>}
            <p>
              {pointAsString(point1)}
            </p>
          </Popup>
        </Marker>}
        {point2 && <Marker
        ...
        >
          <Popup>
            ...
            {/* eslint-disable-next-line @next/next/no-img-element */}
            {point2.hasOwnProperty("imageBase64") && <img src={point2.imageBase64} className={"w-36"} alt={"Point 2"}/>}
            <p>
              {pointAsString(point2)}
            </p>
          </Popup>
        </Marker>}
        {triangulatedPoint && <Marker
          icon={markerIcon}
